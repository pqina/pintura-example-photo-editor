# Pintura Photo Editor example project

A small example project showing how to build a photo editor with Pintura.

Install `@pqina/pintura` and a local node server by running `npm install`, then run `npm start` to start a local server on http://localhost:8080/

[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/pqina/pintura-example-photo-editor?file=index.html)
